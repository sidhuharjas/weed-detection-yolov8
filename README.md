...
## Project Demo
[<video src="demo.mp4" width="100%" controls autoplay muted></video>](https://github.com/sidhuharjas/weed-detection-yolov8/issues/2)


If the embed does not load, <a href="./demo.mp4">download/watch the demo</a>.
